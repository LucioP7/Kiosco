...
namespace KioscoInformaticoBackend.Migrations
{
    ...
    [Migration("20240906172607_inicio")]
            ...
            modelBuilder.Entity("KioscoInformaticoBackend.Models.Venta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClienteId = 1,
                            Fecha = new DateTime(2024, 9, 6, 14, 26, 6, 917, DateTimeKind.Local).AddTicks(5027),
                            FormaPago = 0,
                            Iva = 21m,
                            Total = 3000m
                        },
                        new
                        {
                            Id = 2,
                            ClienteId = 2,
                            Fecha = new DateTime(2024, 9, 6, 14, 26, 6, 917, DateTimeKind.Local).AddTicks(5050),
                            FormaPago = 1,
                            Iva = 10m,
                            Total = 5000m
                        },
                        new
                        {
                            Id = 3,
                            ClienteId = 1,
                            Fecha = new DateTime(2024, 9, 6, 14, 26, 6, 917, DateTimeKind.Local).AddTicks(5052),
                            FormaPago = 2,
                            Iva = 21m,
                            Total = 8000m
                        });
